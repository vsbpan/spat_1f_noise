...
subtitle: "Fine-Scale Spatial Heterogeneity in Phytochemistry and Simple Herbivore Behaviors Create Nontrivial Emergent Effects on Herbivore Performance"
...
d <- ref_data %>% 
  ...
  mutate(
    ...
    sl_mean_pred2 = shape_2 * scale_2, # Exploration state & on less toxic diet
    sl_mean_pred3 = shape_3 * scale_3, # Resting/feeding state & on more toxic diet
    sl_mean_pred4 = shape_4 * scale_4, # Resting/feeding state & on less toxic diet
    k1 = scale_1 / scale_2, # state 1 (exploration)
    k2 = scale_3 / scale_4, # state 2 (resting/feeding)
