...
DataFrame add_random_steps_iterate_statesC(int n, int n_draws, double x_start, double y_start, double direction_start, double diet_start, int state_start, List sl_rand, List ta_rand, double rss_coef, NumericMatrix transition_mat, bool same_move, NumericVector ref_grid_flat, double max_x, double max_y, double dim_x, double dim_y);
RcppExport SEXP _spat1f_add_random_steps_iterate_statesC(SEXP nSEXP, SEXP n_drawsSEXP, SEXP x_startSEXP, SEXP y_startSEXP, SEXP direction_startSEXP, SEXP diet_startSEXP, SEXP state_startSEXP, SEXP sl_randSEXP, SEXP ta_randSEXP, SEXP rss_coefSEXP, SEXP transition_matSEXP, SEXP same_moveSEXP, SEXP ref_grid_flatSEXP, SEXP max_xSEXP, SEXP max_ySEXP, SEXP dim_xSEXP, SEXP dim_ySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type n(nSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(add_random_steps_iterate_statesC(n, n_draws, x_start, y_start, direction_start, diet_start, state_start, sl_rand, ta_rand, rss_coef, transition_mat, same_move, ref_grid_flat, max_x, max_y, dim_x, dim_y));
    return rcpp_result_gen;
END_RCPP
}
// flatten_xy
...
// pick_new_theta_xy
List pick_new_theta_xy(List sl_rand, List ta_rand, int index, int n, double direction_start, double x_start, double y_start, double max_x, double max_y, double dim_x, double dim_y);
RcppExport SEXP _spat1f_pick_new_theta_xy(SEXP sl_randSEXP, SEXP ta_randSEXP, SEXP indexSEXP, SEXP nSEXP, SEXP direction_startSEXP, SEXP x_startSEXP, SEXP y_startSEXP, SEXP max_xSEXP, SEXP max_ySEXP, SEXP dim_xSEXP, SEXP dim_ySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type sl_rand(sl_randSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type dim_x(dim_xSEXP);
    Rcpp::traits::input_parameter< double >::type dim_y(dim_ySEXP);
    rcpp_result_gen = Rcpp::wrap(pick_new_theta_xy(sl_rand, ta_rand, index, n, direction_start, x_start, y_start, max_x, max_y, dim_x, dim_y));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_spat1f_add_random_steps_iterate_statesC", (DL_FUNC) &_spat1f_add_random_steps_iterate_statesC, 17},
    {"_spat1f_flatten_xy", (DL_FUNC) &_spat1f_flatten_xy, 6},
    {"_spat1f_pick_new_theta_xy", (DL_FUNC) &_spat1f_pick_new_theta_xy, 11},
    {NULL, NULL, 0}
};
