...
sem_summary <- suppressWarnings(suppressMessages(summary_psem(sem_fit)))
...
# Latent theoretic standarized coefficient of beta regression 
fixef(subm_on_toxic)$cond[-1] * 1 / sqrt(var(predict(subm_on_toxic)) + pi^2/3)
```
...
knitr::include_graphics("graphs/small_cat_SEM.png")
...
knitr::include_graphics("graphs/large_cat_SEM.png")
